...
namespace SharedRevit.Commands
{
    ...
    public class SheetSettingsMenu : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Forms.Settings.SheetSettings sheetSettings = new Forms.Settings.SheetSettings();
    ...
    public class SheetActualCreate
    {
        ...
        public static Result Run(ExternalCommandData commandData, List<ViewPlan> Selected)
        {
            ...
            //start forn
            SharedRevit.Forms.SheetCreateForm form = new SharedRevit.Forms.SheetCreateForm(commandData, Selected);
            form.ShowDialog();
            ...
            foreach (Viewport viewport in viewports)
            {
                ...
                try
                {
                    ...
                    viewport.ChangeTypeId(ConvertStringToElementId(scales[sheetscale.Remove(0, 1).Remove(sheetscale.Length - 2, 1)].Item1));
                }
                catch
                {
        ...
        static ElementId ConvertStringToElementId(string idString)
        {
