...
namespace SharedRevit.Commands
{
    ...
    public class Excel
    {
        ...
        private static ElementId getRevitBoarderIDFromExcel(ExcelBorderItem border)
        {
            ...
            //get color
            Color color = ExcelColorToRevit(border.Color, "#FF000000", "#FFFFFFFF");
            int r = color.Red;
            int g = color.Green;
            int b = color.Blue;
        ...
        private static ElementId createLineType(int weight, Color color)
        {
            int r = color.Red;
            int g = color.Green;
            int b = color.Blue;
        ...
        private static Color ExcelColorToRevit(ExcelColor ExcColor, string defaultColorHex)
        {
            ...
            int argb = int.Parse(RGBhex.Replace("#", ""), NumberStyles.HexNumber);
        ...
        private static Color ExcelColorToRevit(ExcelColor ExcColor, string defaultColorHex, string notColor)
        {
            string RGBhex = ExcColor.LookupColor();
