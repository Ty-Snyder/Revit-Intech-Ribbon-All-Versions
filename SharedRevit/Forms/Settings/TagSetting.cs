...
namespace SharedRevit.Forms.Settings
{
    public partial class TagSetting : System.Windows.Forms.Form
    {
        ...
        public TagSetting()
        {
            ...
            SaveFileManager saveFileManager = new SaveFileManager(path, new TxtFormat());
            ...
            TagSettings.ConfigureColumnTypes(new Dictionary<string, SharedRevit.Forms.ColumnType> 
            {
                { "Tag Type", SharedRevit.Forms.ColumnType.ComboBox },
                { "Category", SharedRevit.Forms.ColumnType.ComboBox },
                { "Path", SharedRevit.Forms.ColumnType.FilePicker },
                { "Leader", SharedRevit.Forms.ColumnType.CheckBox }
            });
