...
namespace SharedRevit.Forms
{
    public partial class SharedParameterAdd : System.Windows.Forms.Form
    {
        ...
        public SharedParameterAdd(UIApplication app)
        {
            ...
            InitializeComponent();
            CenterToParent();
            families = RevitUtils.GetFamilies();
            defGroups = RevitUtils.GetDefinitionGroups();
            ...
            groups = RevitUtils.GetAllGroupTypeIds();
        ...
        private void Confirm_Click(object sender, EventArgs e)
        {
            ...
            AddSharedParametersHandler test = new AddSharedParametersHandler(selectedFamilies, selectedDefinitions, group, InstanceSelect.Checked);
            test.Execute(app);
        }
